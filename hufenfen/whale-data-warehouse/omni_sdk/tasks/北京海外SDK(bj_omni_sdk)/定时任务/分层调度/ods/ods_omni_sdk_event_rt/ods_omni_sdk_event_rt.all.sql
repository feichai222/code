...
WHERE
    dt BETWEEN '${iterStartDate}' AND '${iterEndDate}'
    AND from_unixtime(CAST(get_json_object(regexp_replace (raw_json, '#', '' ), '$.time_ms')/1000 AS BIGINT), 'yyyy-MM-dd') BETWEEN '${iterStartDate}' AND '${iterEndDate}'
